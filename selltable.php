...
$mysqlquery4 = "insert into product(p_name , p_description , seller , buyer , base_amount , bid_amount , image , sold) values ('{$p_name}','{$p_description}', '{$email}', ' ', '{$base_amount}', 0, '{$img}', false)";
